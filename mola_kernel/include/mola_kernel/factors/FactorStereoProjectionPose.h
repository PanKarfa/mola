...
class FactorStereoProjectionPose : public FactorBase
{
 ...
 public:
  ...
  FactorStereoProjectionPose(
      double sigma_xleft, double sigma_xright, double sigma_y, const StereoObservation& st,
      const id_t observing_kf, const id_t observed_landmark, const id_t camera_params,
